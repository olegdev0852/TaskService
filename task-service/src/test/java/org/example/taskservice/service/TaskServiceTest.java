...
class TaskServiceTest {
    ...
    @Test
    void createTask_WithoutName_ShouldThrowConstraintViolationException() {
        ...
        assertTrue(exception.getRootCause() instanceof ConstraintViolationException);
    }
    ...
    void updateTask_WithNameAndDescription_UpdatesTask() {
        ...
        TaskRequestDto updateRequest = new TaskRequestDto("Updated Name", "Updated Description");
        taskService.updateTask(createdTask.id(), updateRequest);
    ...
    void updateTask_WithOnlyName_UpdatesOnlyName() {
        ...
        TaskRequestDto updateRequest = new TaskRequestDto("Updated Name", null);
        taskService.updateTask(createdTask.id(), updateRequest);
    ...
    void updateTask_WithOnlyDescription_UpdatesOnlyDescription() {
        ...
        TaskRequestDto updateRequest = new TaskRequestDto(null, "Updated Description");
        taskService.updateTask(createdTask.id(), updateRequest);
    ...
    void updateTask_WithSameData_DoesNotUpdate() {
        ...
        TaskRequestDto updateRequest = new TaskRequestDto("Original Name", "Original Description");
        taskService.updateTask(createdTask.id(), updateRequest);
    ...
    void updateTask_WhenTaskNotExists_ThrowsTaskNotFoundException() {
        TaskRequestDto updateRequest = new TaskRequestDto("New Name", "New Description");
